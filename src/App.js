...
class App extends React.Component{
  ...
  componentDidMount() {
    var zt = new ZingTouch
      .Region(document.getElementsByClassName('buttons-container')[0]);
    ...
    zt.bind(document.getElementsByClassName('buttons-container')[0], 'rotate', (event) => {
      ...
      if (this.change_in_angle > 15) {
        ...
        console.log('clockwise'); this.change_in_angle = 0;

      } else if (this.change_in_angle < -15) {

        console.log('anti-clockwise'); this.change_in_angle = 0;
      }
